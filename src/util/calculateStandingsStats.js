...
export const calculateWinPercentage = (W, L) => {
    return W + L === 0 ? 0 : (W / (W + L));
}

export const calculateRunDifferential = (rs, ra) => {
    return rs - ra;
}

export const calculatedExpectedWL = (rs, ra, games, exponent = 1.83) => {
...
export const calculateGamesBack = (teams, groupBy = "division") => {
    const grouped = {};
    const results = [];
...
export const calculatedWildCard = (teams) => {
